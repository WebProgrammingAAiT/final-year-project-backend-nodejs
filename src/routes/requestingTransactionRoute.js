...
router.get("/transactions/requesting/pending", requestingTransactionCtrl.getPendingRequestingTransactions);
router.get("/transactions/requesting/approved", requestingTransactionCtrl.getApprovedRequestingTransactions);
